...
if (${CMAKE_SYSTEM_NAME} STREQUAL "Windows")
	...
	find_path (DirectX_ROOT_DIR
		...
		PATHS
			"$ENV{DXSDK_DIR}"
			"$ENV{${PROGWIN64}}/Microsoft DirectX SDK (June 2010)"
			"$ENV{${PROGWIN32}}/Microsoft DirectX SDK (June 2010)"
			"$ENV{${PROGWIN64}}/Microsoft DirectX SDK (February 2010)"
			"$ENV{${PROGWIN32}}/Microsoft DirectX SDK (February 2010)"
			"$ENV{${PROGWIN64}}/Microsoft DirectX SDK (March 2009)"
			"$ENV{${PROGWIN32}}/Microsoft DirectX SDK (March 2009)"
			"$ENV{${PROGWIN64}}/Microsoft DirectX SDK (August 2008)"
			"$ENV{${PROGWIN32}}/Microsoft DirectX SDK (August 2008)"
			"$ENV{${PROGWIN64}}/Microsoft DirectX SDK (June 2008)"
			"$ENV{${PROGWIN32}}/Microsoft DirectX SDK (June 2008)"
			"$ENV{${PROGWIN64}}/Microsoft DirectX SDK (March 2008)"
			"$ENV{${PROGWIN32}}/Microsoft DirectX SDK (March 2008)"
			"$ENV{${PROGWIN64}}/Microsoft DirectX SDK (November 2007)"
			"$ENV{${PROGWIN32}}/Microsoft DirectX SDK (November 2007)"
			"$ENV{${PROGWIN64}}/Microsoft DirectX SDK (August 2007)"
			"$ENV{${PROGWIN32}}/Microsoft DirectX SDK (August 2007)"
			"$ENV{${PROGWIN64}}/Microsoft DirectX SDK"
			"$ENV{${PROGWIN32}}/Microsoft DirectX SDK"
	...
	if (DEFINED MSVC_VERSION AND NOT ${MSVC_VERSION} LESS 1700)
		find_path (WIN8_SDK_ROOT_DIR
			Include/10.0.10586.0/um/windows.h
			PATHS
		...
		if (WIN8_SDK_ROOT_DIR)
			set (DirectX_INC_SEARCH_PATH "${WIN8_SDK_ROOT_DIR}/Include/10.0.10586.0/um" "${WIN8_SDK_ROOT_DIR}/Include/shared")
